...
export default function ArchivesPage() {
  const { archives, deleteArchive, company } = useEmployees();
                                ...
                                <div className="flex justify-between items-start">
                                  <div>
                                    ...
                                    <p className="text-muted-foreground mb-2">
                                      Total payé : <span className="font-bold text-primary">{formatCurrency(archive.totalPayroll, company?.currency)}</span>
                                    </p>
                                  </div>
                                  <AlertDialog>
                                    ...
                                    <TableBody>
                                        {archive.departments.map(dept => (
                                            <TableRow key={dept.name}>
                                                ...
                                                <TableCell className="text-right">{formatCurrency(dept.total, company?.currency)}</TableCell>
                                            </TableRow>
                                        ))}
                                    </TableBody>
                                </Table>
